...
class CampingChatbot:
    ...
    def get_user_info(self):
        ...
        self.toilet = input("Moet ik een kampeerplek regelen die niet te ver van 't toilet is? ")
        self.speeltuin = input("Wil je een plekje dichtbij de speeltuin? ")
    ...
    def main(self):
        ...
        user_input = input('Wil je blijven chatten? (ja/nee): ')
        if user_input.lower() == 'nee':
            self.stop_program()
        else:
